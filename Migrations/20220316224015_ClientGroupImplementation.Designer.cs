...
namespace Bicks.Migrations
{
    ...
    [Migration("20220316224015_ClientGroupImplementation")]
    partial class ClientGroupImplementation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bicks.Models.ClientGroup", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal?>("PricePerKgOverride")
                        .HasColumnType("Decimal(18, 2)");

                    b.Property<decimal?>("PricePerUnitOverride")
                        .HasColumnType("Decimal(18, 2)");
            ...
            modelBuilder.Entity("Bicks.Models.ProductOption", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("NumTimesPurchased")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bicks.Models.Client", b =>
                {
                    b.HasOne("Bicks.Models.ClientGroup", "ClientGroup")
                        .WithMany()
            ...
            modelBuilder.Entity("Bicks.Models.ProductOption", b =>
                {
                    b.HasOne("Bicks.Models.Client", null)

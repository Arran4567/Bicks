...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bicks.Models.EventHistory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bicks.Models.Task", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bicks.Models.Complaint", b =>
                {
                    b.HasOne("Bicks.Models.EventHistory", "Event")
                        .WithMany()
            ...
            modelBuilder.Entity("Bicks.Models.Job", b =>
                {
                    ...
                    b.HasOne("Bicks.Models.JobStatus", "StatusId")
                        .WithMany()
            ...
            modelBuilder.Entity("Bicks.Models.Quote", b =>
                {
                    b.HasOne("Bicks.Models.EventHistory", "EventItem")
                        .WithMany()
                        .HasForeignKey("EventHistoryId");
                });
